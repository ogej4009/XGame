...
// XTool.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CXToolApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CXToolApp::OnAppAbout)
END_MESSAGE_MAP()


// CXToolApp 생성

CXToolApp::CXToolApp() noexcept
{

	// TODO: 아래 애플리케이션 ID 문자열을 고유 ID 문자열로 바꾸십시오(권장).
	// 문자열에 대한 서식: CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("XTool.AppID.NoVersion"));
